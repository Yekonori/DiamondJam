    ...
    public class VD : MonoBehaviour
    {
        ...
        public class NodeData
        {
            ...
            public NodeData(NodeData nd)
            {
                ...
                sprite = nd.sprite;
                // ===  NAM  ==== /
                characterData = nd.characterData;
            ...
            if (cur != null)
                if (cur.playerDiags != null)
                    for (int i = 0; i < cur.playerDiags.Count; i++)
                    {
                        ...
                        diags[currentDiag].playerNodes[i].characterData = cur.playerDiags[i].characterData;
                ...
                if (cur != null)
                    if (cur.playerDiags != null)
                        for (int i = 0; i < cur.playerDiags.Count; i++)
                        {
                            ...
                            diags[theIndex].playerNodes[i].characterData = cur.playerDiags[i].characterData;
        ...
        public static bool Load(string dName)
        {
            ...
            // ================================ NAM  ================================================
            SO_CharacterData[] cDatas = Resources.LoadAll<SO_CharacterData>("");
        ...
        private static NodeData GetNodeDataForPlayer(DialogueNode diagNode)
        {
            ...
            nd.characterData = diagNode.characterData;
        ...
        public static void SetCurrentLanguage(string lang)
        {
            ...
            if (nodeData != null && currentPlayerStep != null)
            {
                ...
                nodeData.characterData = currentPlayerStep.characterData;
